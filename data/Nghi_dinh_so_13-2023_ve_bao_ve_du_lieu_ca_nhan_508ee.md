...
Chủ thể dữ liệu có quyền tự bảo vệ theo quy định của Bộ luật Dân sự, luật khác có liên quan và Nghị định này, hoặc yêu cầu cơ quan, tổ chức có thẩm quyền thực hiện các phương thức bảo vệ quyền dân sự theo quy định tại Điều 11 Bô luât Dân sự.
...
- a) Nhận thấy không còn cần thiết cho mục đích thu thập đã đồng ý và chấp nhân các thiệt hại có thể xảy ra khi yêu cầu xóa dữ liệu;
  - b) Rút lại sự đồng ý;
...
- c) Mô tả các hậu quả, thiệt hại có thể xảy ra của việc vi phạm quy định bảo vê dữ liệu cá nhân;
...
- b) Bên chuyển dữ liệu ra nước ngoài không chấp hành quy định tại khoản 5,
   khoản 6 Điều này;
  - c) Để xảy ra sự cố lộ, mất dữ liệu cá nhân của công dân Việt Nam.

## Mục 4 BIỆN PHÁP, ĐIỀU KIỆN BẢO ĐẨM BẢO VỆ DỮ LIỆU CÁ NHÂN
...
- b) Bộ phận, nhân sự có chức năng bảo vệ dữ liệu cá nhân được chỉ định trong cơ quan, tổ chức, doanh nghiệp nhằm bảo đảm thực hiện quy định về bảo vê dữ liệu cá nhân;
...
3. Bảo đảm cơ sở vật chất, điều kiện hoạt động cho Cơ quan chuyên trách bảo vê dữ liệu cá nhân.
...
### Chương III TRÁCH NHIỆM CỦA CƠ QUAN, TỔ CHÚC, CÁ NHÂN
...
- Bộ trưởng Bộ Công an đôn đốc, kiểm tra, hướng dẫn việc thực hiện Nghị định này.
...
<sup>&</sup>lt;sup>2</sup> Ghi nơi cư trú của người đại diện/người giám hộ.

<sup>&</sup>lt;sup>3</sup> Ghi số điện thoại, fax, email của người đại diện/giám hộ.

<sup>&</sup>lt;sup>4</sup> Ghi rõ tên chủ thể dữ liệu và các thông tin liên quan cần cung cấp.

<sup>&</sup>lt;sup>5</sup> In, sao, chụp hoặc file dữ liệu.
...
| 3. Số CMTND/Thẻ căn cước công dân/Hộ chiếu<br>cấp ngày/tại |
| 4. Địa chỉ trụ sở của tổ chức, doanh nghiệp:               |
| 5. Số điện thoại <sup>2</sup> ; E-mail:;                   |
...
<sup>&</sup>lt;sup>2</sup> Ghi số điện thoại, fax, email của người đại diện yêu cầu cung cấp thông tin.

 <sup>&</sup>lt;sup>3</sup> In, sao, chụp hoặc file dữ liệu.
...
| Thực hiện quy định về bảo vệ dữ liệu cá nhân,                                                                                                                                 |
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 1. Thông tin về tổ chức, doanh nghiệp                                                                                                                                         |
| - Tên tổ chức, doanh nghiệp:                                                                                                                                                  |
| - Địa chỉ trụ sở chính:                                                                                                                                                       |
| - Địa chỉ trụ sở giao dịch:                                                                                                                                                   |
| <ul> <li>Quyết định thành lập/Giấy chứng nhận đăng ký doanh nghiệp/Giấy<br/>chứng nhận đăng ký kinh doanh/Giấy chứng nhận đầu tư số: do cấp<br/>ngày tháng năm tại</li> </ul> |
| - Điện thoại: Website                                                                                                                                                         |
...
| - Địa điểm:                                                                                                                                                                   |
| - Hành vi:                                                                                                                                                                    |
| Tổ chức, cá nhận, các loại dữ liệu cá nhân và số lượng dữ liệu liên quan                                                                                                      |
...
|               | 2                                                                                                                                                    |
|               | 4. Cam kết                                                                                                                                           |
| pháp<br>theo. | (Tên cơ quan, tổ chức, doanh nghiệp) xin cam kết: Chịu trách nhiệm trước luật về tính chính xác và tính hợp pháp thông tin cung cấp và tài liệu kèm. |
| Noi n         | •                                                                                                                                                    |
...
# THÔNG BÁO GỬI HÒ SƠ ĐÁNH GIÁ TÁC ĐỘNG XỬ LÝ DỮ LIỆU CÁ NHÂN

| ·                                                                                                                                                                             |
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Kính gửi: Bộ Công an<br>(Cục An ninh mạng và phòng, chống tội phạm sử dụng công nghệ cao, Bộ Công an)                                                                         |
| Thực hiện quy định về bảo vệ dữ liệu cá nhân,                                                                                                                                 |
| 1. Thông tin về tổ chức, doanh nghiệp                                                                                                                                         |
| - Tên tổ chức, doanh nghiệp:                                                                                                                                                  |
| - Địa chỉ trụ sở chính:                                                                                                                                                       |
...
<sup>&</sup>lt;sup>1</sup> Tên tổ chức, doanh nghiệp.
...
# THÔNG BÁO THAY ĐỔI NỘI DUNG HÒ SƠ ......¹

Kính gửi: Bộ Công an (Qua Cục An ninh mạng và phòng, chống tội phạm sử dụng công nghệ cao)

| (Qua Các / III limit mạng và phòng, chong tọi phạm sa dạng công nghệ cao)                                                                                                     |
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Thực hiện quy định về bảo vệ dữ liệu cá nhân,                                                                                                                                 |
| 1. Thông tin về tổ chức, doanh nghiệp                                                                                                                                         |
| - Tên tổ chức, doanh nghiệp:                                                                                                                                                  |
...
<sup>&</sup>lt;sup>1</sup> Tên hồ sơ: Hồ sơ đánh giá tác động xử lý dữ liệu cá nhân hoặc Hồ sơ đánh giá tác động chuyển dữ liệu cá nhân ra nước ngoài.

<sup>&</sup>lt;sup>2</sup> Tên tổ chức, doanh nghiệp.
...
### HÒ SƠ ĐÁNH GIÁ TÁC ĐỘNG CHUYỂN DỮ LIỆU CÁ NHÂN RA NƯỚC NGOÀI

Kính gửi: Bộ Công an (Cuc An ninh mang và phòng, chống tội phạm sử dụng công nghệ cao, Bộ Công an) Thực hiện quy định về bảo vệ dữ liệu cá nhân, ...... gửi Bộ Công an Hồ sơ đánh giá tác đông chuyển dữ liệu cá nhân ra nước ngoài, như sau: 1. Thông tin về tổ chức, doanh nghiệp - Tên tổ chức, doanh nghiệp: ..... - Đia chỉ tru sở chính:.... - Địa chỉ trụ sở giao dịch: ..... - Quyết định thành lập/Giấy chứng nhận đăng ký doanh nghiệp/Giấy chứng nhận đăng ký kinh doanh/Giấy chứng nhận đầu tư số: ..... do .... cấp ngày ... tháng ... năm ... tại ... - Điện thoại: ...... Website ..... - Nhân sư chiu trách nhiệm bảo vệ dữ liệu cá nhân:..... Ho và tên: ..... Chức danh: ..... Số điện thoại liên lạc (cố định và di động): ..... Email:.... 2. Hồ sơ đánh giá tác động chuyển dữ liệu cá nhân ra nước ngoài 1. ..... 2. .....
