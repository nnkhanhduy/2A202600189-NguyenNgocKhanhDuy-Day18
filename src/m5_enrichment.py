...
def extract_metadata(text: str) -> dict:
    ...
    try:
        ...
        resp = client.chat.completions.create(
            model="gpt-4o-mini",
            messages=[
                {"role": "system", "content": 'Trích xuất metadata từ đoạn văn. Trả về đúng 1 JSON: {"topic": "...", "entities": ["..."], "category": "policy|hr|it|finance", "language": "vi|en"}'},
                {"role": "user", "content": text},
            ],
            max_tokens=150,
            temperature=0.1
        ...
        print(f"Extract metadata fallback: {e}")
        return {}
